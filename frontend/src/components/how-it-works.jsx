export default function HowItWorks() {
  ...
  return (
    <section className="rounded-xl border border-border bg-card p-6">
      <div className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground mb-4">How settlement works</div>
      <div className="grid grid-cols-3 gap-6">
        {steps.map((s) => (
          <div key={s.num}>
            <div className="text-xs font-mono text-blue-500 mb-2">{s.num}</div>
