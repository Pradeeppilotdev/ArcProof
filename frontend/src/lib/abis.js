...
export const wrAbi = [
  ...
  { inputs: [{ internalType: "uint256", name: "reward", type: "uint256" }, { internalType: "bytes32", name: "outputHash", type: "bytes32" }, { internalType: "uint64", name: "deadline", type: "uint64" }, { internalType: "uint256", name: "_salt", type: "uint256" }], name: "postTask", outputs: [{ internalType: "uint256", name: "taskId", type: "uint256" }], stateMutability: "nonpayable", type: "function" },
];
