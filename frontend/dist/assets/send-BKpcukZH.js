import{c$ as b,d2 as d,dG as u,d3 as x,d4 as v,d6 as H,dm as O,dk as g,df as V,eh as a,d5 as c,d8 as L,dd as h,db as E,d9 as I,e6 as G,de as y,dr as Q,dq as X,dD as K,d0 as Y,d1 as J,dF as Z,eo as M,ep as q,dh as ee}from"./index-DWGP_c6U.js";import"./index-DKGD23WK.js";import"./index-woef-Qdv.js";import{S as P}from"./SwapController-DfOeH85A.js";const te=b`
  :host {
    width: 100%;
    height: 100px;
...
`;var ue=function(e,t,i,o){var r=arguments.length,n=r<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,o);else for(var l=e.length-1;l>=0;l--)(s=e[l])&&(n=(r<3?s(n):r>3?s(t,i,n):s(t,i))||n);return r>3&&n&&Object.defineProperty(t,i,n),n};let F=class extends v{constructor(){super(),this.unsubscribe=[],this.unsubscribe.push()}render(){return c`
    ...
    `}onCloseClick(){G.close()}};F.styles=ce;F=ue([x("w3m-send-confirmed-view")],F);export{F as W3mSendConfirmedView,C as W3mSendSelectTokenView,p as W3mWalletSendPreviewView,f as W3mWalletSendView};
