import{e6 as k,ew as le,dd as c,df as pe,c$ as v,d0 as V,d3 as f,d4 as g,d5 as d,d2 as l,dF as $,dp as H,dG as u,d1 as me,dk as w,d7 as B,dD as U,em as fe,ec as F,dh as K,e0 as A,dt as M,da as we,de as E,e8 as z,ej as oe,dE as be,d9 as ce,ex as ge,ey as ye}from"./index-aaR4b0iX.js";import{P as D}from"./index-CBcy6AKa.js";import{S as ve}from"./SwapController-BMA198Sm.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
