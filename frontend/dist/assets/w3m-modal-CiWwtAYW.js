import{da as v,d4 as f,d5 as a,d2 as w,dG as d,dF as q}from"./index-s-5Rkhyf.js";import{k as ve,s as fe,l as ge,p as be,M as g,S as re,R as l,h as P,A as K,j as ce,i as le,C as m,m as Y,n as ye,o as S,E as ie,O as E,q as F,u as oe,v as T,x as H,T as xe,y as Ce,z as ke,B as Se}from"./core-DgbAkZwV.js";import{c as u,U as We}from"./index-DGADKmke.js";import"./index.es-CUnNjXHH.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(s){return ge(p,()=>s(p))},subscribeKey(s,e){return fe(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await re.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
