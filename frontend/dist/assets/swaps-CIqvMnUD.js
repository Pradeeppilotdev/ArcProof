import{c$ as D,dG as l,d2 as m,d3 as C,d4 as L,dk as S,db as d,d5 as u,dr as V,dh as N,dd as P,dm as F,e6 as M,di as K,dj as Q,d0 as W,d1 as q,en as _}from"./index-DWGP_c6U.js";import{S as r}from"./SwapController-DfOeH85A.js";import"./index-woef-Qdv.js";const G={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",x=a==="c",$=a==="v",E=a==="x",A=n===",",R=n===".",B=n>="0"&&n<="9";!s&&(c||x||$||E)&&e.preventDefault(),t==="0"&&!A&&!R&&n==="0"&&e.preventDefault(),t==="0"&&B&&(o(n),e.preventDefault()),(A||R)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!B&&!i.includes(n)&&!R&&!A&&e.preventDefault()}},H=D`
  :host {
    width: 100%;
  }
