import{c$ as U,d0 as Ie,d1 as Te,d2 as b,d3 as _,d4 as C,dF as f,d5 as l,dg as I,ez as Se,df as T,eA as ke,eB as y,dm as O,eC as _e,eD as N,e0 as ce,db as A,eE as me,dk as m,dD as v,dh as M,de as R,dq as Ce,e6 as G,du as $e,dv as Re,dw as Oe,dt as P,dd as z,dG as h,d7 as Ue,d9 as Le,ev as Ne,da as qe,en as ge}from"./index-D9QgaDSl.js";const De=U`
  :host {
    position: relative;
  }
...
`;var ve=function(t,e,n,s){var i=arguments.length,a=i<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,e,n,s);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(a=(i<3?o(a):i>3?o(e,n,a):o(e,n))||a);return i>3&&a&&Object.defineProperty(e,n,a),a};let Z=class extends C{constructor(){super(),this.unsubscribe=[],this.selectedExchange=u.state.selectedExchange,this.unsubscribe.push(u.subscribeKey("selectedExchange",e=>this.selectedExchange=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const e=!!this.selectedExchange;return l`
    ...
    `}dispatchConnectOtherWalletEvent(){this.dispatchEvent(new CustomEvent("connectOtherWallet",{detail:!0,bubbles:!0,composed:!0}))}};Z.styles=[xt];ve([b({type:Array})],Z.prototype,"selectedExchange",void 0);Z=ve([_("w3m-pay-options-empty")],Z);const bt=U`
  :host {
    display: block;
    width: 100%;
  }
